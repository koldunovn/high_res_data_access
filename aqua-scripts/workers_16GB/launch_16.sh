...
#SBATCH --job-name=data-access_16
#SBATCH --output=data-access_16_%j.out
#SBATCH --error=data-access_16_%j.err
...
freq=monthly
regrid=r100
outdir=/scratch/project_462000911/mnurisso/data-access-workers/${nproc}_16GB
mkdir -p $outdir
