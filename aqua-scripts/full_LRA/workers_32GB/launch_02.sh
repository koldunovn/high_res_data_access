...
#SBATCH --job-name=data-access_02
#SBATCH --output=data-access_02_%j.out
#SBATCH --error=data-access_02_%j.err
...
freq=monthly
regrid=r100
outdir=/scratch/project_462000911/mnurisso/data-access-workers/${nproc}_32GB
mkdir -p $outdir
